// Tenant Admin AI Controls — manages tenant-scoped AI settings via GET/PUT /api/admin/ai/settings
// Same backend endpoint, tenant-scoped via auth token.
    ...
    <div className="quizzes-page">
      <div className="mb-4">
        ...
        <p className="text-muted mb-0">
          Configure AI features and usage limits for your institution.
        </p>
      </div>

      <div className="dash-card mb-4">
        <h3 className="dash-card-title mb-4">Settings</h3>
        <div className="row g-4">
          <div className="col-md-6">
            <div className="form-check form-switch mb-4">
              ...
              <div className="form-text">
                Disabling this turns off all AI features for your institution.
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="form-text">
                Tone used when AI drafts grade feedback for teachers.
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="mb-3">
              ...
              />
              <div className="form-text">Usage warning threshold per day (tokens).</div>
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                step={5000}
                onChange={(e) =>
                  setField("softCapWeekly", Number(e.target.value))
                }
              />
              <div className="form-text">Usage warning threshold per week (tokens).</div>
            </div>
          </div>
        </div>
      </div>
